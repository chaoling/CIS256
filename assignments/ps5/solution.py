...
class BinarySearchTree(object):
    ...
    def search(self, bidId: str)->Bid:
        ...
        ans = searchNode(self.root,bidId)
        return ans
    ...
    def remove(self, bidId: str)->None:
        ...
        def removeNode(node: Node, bidId: int)->Node:
            ...
            else: #match node found
                if node.left is None and node.right is None:
                    node = None #remove the node, let it gabage collected
                    ...
                    #exchange the content of the node with minNode and delet minNode recursively
            ...
            # call itself recursively to the right subtree
                   ...
                   #do the opposite 
                    ...
                    #hint: the minimum of the subtree is the left most leaf node, find it , replace it 
