...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        return dict(zip(alphabet, shift_alphabet))
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            potential_decryption = self.apply_shift(shift)
            words = potential_decryption.split(' ')
            ...
            if valid_words_count > max_valid_words:
                ...
                best_shift = shift
                decrypted_message = potential_decryption
